using Haha.Music.Application.Contracts.Identity;
using Haha.Music.Application.Models.Identity;
using Haha.Music.Identity.Models;
using Haha.Music.Identity.Services;
    ...
    public static class IdentityServicesRegistration
    {
        public static IServiceCollection ConfigureIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<LeaveManagementIdentityDbContext>(options =>
                options.UseSqlServer(configuration.GetConnectionString("HahaMusicIdentityConnectionString"),
